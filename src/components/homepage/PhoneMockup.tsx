    ...
    return (
      ...
      >
        ...
        <Container className="relative">
          <div className="grid lg:grid-cols-2 gap-lg lg:gap-2xl items-end min-h-[320px] lg:min-h-[380px]">
            <div className="pt-4xl pb-2xl lg:py-5xl">
              ...
              <div className="mt-xl lg:mt-2xl inline-block bg-surface-alt p-sm rounded-sm">
                <OptimizedImage
            ...
            <div className="flex justify-center lg:justify-start">
              <div className="w-[68%] max-w-[15rem] sm:max-w-[20rem] lg:w-[85%] lg:max-w-[28rem]">
                <OptimizedImage
